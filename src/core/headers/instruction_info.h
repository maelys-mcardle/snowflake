...
typedef enum {
    ...
    INSTRUCTION_OR              = 42,
    INSTRUCTION_XOR             = 43,
    INSTRUCTION_PREPEND_ARRAY   = 50,
    INSTRUCTION_APPEND_ARRAY    = 51,
    INSTRUCTION_GET_FIRST       = 52,
    INSTRUCTION_GET_LAST        = 53,
    INSTRUCTION_REMOVE_FIRST    = 54,
    INSTRUCTION_REMOVE_LAST     = 55,
    INSTRUCTION_MOVE_FIRST_TO_INDEX = 56,
    INSTRUCTION_MOVE_LAST_TO_INDEX  = 57,
    INSTRUCTION_MOVE_TO_FIRST   = 58,
    INSTRUCTION_MOVE_TO_LAST    = 59,
} InstructionCode;
